		...
		<div class="mainLayout" style="">
			...
			<div class="body">
				...
				<div class="btn-bar">
					...
					<div>
						<input type="button" value="查询" onclick="initUserList();" class="mybutton"  style="width:60px;"/>
					</div>
				</div>
				<div class="data-body">
					<table class="header">
		...
		<div id="createUserDialog" class="Dialog" style="display: none;">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
				<tr>
					...
					<td><input type="text" id="user_name"  node-type="text" placeholder="请输入真实姓名"/></td>
				...
				<tr>
					...
					<td><input type="text" id="login_name"  node-type="text" placeholder="请输入用户名"/></td>
					<td class="msg-css">创建后不可修改，只能包含字母、数字、下划线、中划线 。</td>
				</tr>
				<tr>
					<td align="right">密　码：</td>
					<td><input type="password" id="password" node-type="text" placeholder="请输入密码"/></td>
					<td class="msg-css"></td>
				</tr>
				<tr>
					<td align="right">确认密码：</td>
					<td><input type="password" id="cfm_password"  node-type="text" placeholder="请输入确认密码"/></td>
					<td class="msg-css"></td>
				</tr>
				<tr>
