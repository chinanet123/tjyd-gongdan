...
/************************************************************************************************************/
		...
		<script type="text/javascript">
			...
			function exportExcel(){
				...
				exportForm.submit();
				//window.location.href = contextPath + "/export.do?customerId="+customerId;
				//window.location.href = contextPath + "/clientResouce.htm?customerId="+customerId;
		...
		<div class="mainLayout" style="">
			...
			<div class="body">
				<div class="title-button border-all">
					...
					<div class="btn">
						<form action="<%=request.getContextPath() %>/export.do" name="exportForm" method="POST">
							<a type="button" class="mybutton" style="" href="<%=request.getContextPath()%>/clientResourcePrint.htm?customerId=<%=customerId %>" target="blank">打 印</a>
							<input type="hidden" value="<%=customerId %>" id="customerId" name="customerId"/>
							<input type="submit" class="mybutton" onclick="exportExcel();" value="导出Excel"/>
						</form>	
					</div>
				</div>
				<div class="data-body">
